...
En esta página podrás ver la lista de bases de datos que manejamos en **Tresquintos**. Hay dos categorías: **bases gratuitas** y **bases premium**. Hay cinco series de datos: presidenciales, senadores, diputados, municipales, alcaldes, concejales y otros. Cada serie se divide en distintas bases de datos. A su vez, cada base de datos viene con un un enlace a la descarga directa de los datos en formato Excel (**.xlsx**), un enlace con el permalink para importar los datos desde GitHub (**.csv**), y un enlace con un archivo que contiene toda la información relativa a los datos (i.e., detalles de matriz; descripción de variables; fuentes; referencia; contacto), además de los códigos exactos para la importación directa de los datos desde **Stata** o **R** (en formato **".txt"**).
...
- Elección presidencial 2000 (2v)
  ...
  - [readme.txt](https://raw.githubusercontent.com/tresquintos/datos/master/presidenciales/readme_99_2v.txt)
...
- Elección presidencial 2006 (2v)
  ...
  - [readme.txt](https://raw.githubusercontent.com/tresquintos/datos/master/presidenciales/readme_05_2v.txt)
...
- Elección presidencial 2010 (2v)
  ...
  - [readme.txt](https://raw.githubusercontent.com/tresquintos/datos/master/presidenciales/readme_09_2v.txt)
