...
Abajo puedes ver las encuestas más recientes que han medido intención de voto (o popularidad presidencial) para candidatos a la elección presidencial de 2021. La tabla incluye la fecha de la encuesta, el nombre de la encuestadora, el número de encuestados, una columna que indica si la encuesta fue declarada como "voto probable", los tres nombres de los candidatos con mayor popularidad en las encuestas, y el porcentaje de apoyo (intención de voto/popularidad electoral).
