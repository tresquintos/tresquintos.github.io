...
\author{}
\date{\vspace{-2.5em}aktualisiert: 2024-03-04}
...
\textbf{Zusammenfassung}: Präsident Gabriel Boric ist seit 724 Tagen im
Amt, was etwa 49.6\% seiner Amtszeit entspricht (2022 - 2026).
...
Zahlen zeigen an, dass Boric eine Zustimmung von 29.1\% und eine
Ablehnung von 62.6\% hat. \textbf{Durchschnitt}: Die Zustimmung schwankt
um -0.3\% pro Monat, während die Ablehnung um 0.6\% alle 30 Tage
schwankt. \textbf{Daten}: Dieser Bericht wurde automatisch anhand der
von Tresquintos gesammelten 297-Umfragen (ab 2022-03-11) erstellt.
